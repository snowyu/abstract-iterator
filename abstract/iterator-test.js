...
module.exports.iterator = function (NoSqlDatabase, test, testCommon, collectEntries) {
...
module.exports.snapshot = function (NoSqlDatabase, test, testCommon) {
...
module.exports.all = function (NoSqlDatabase, test, testCommon) {
  ...
  module.exports.iterator(NoSqlDatabase, test, testCommon, testCommon.collectEntries)
  module.exports.snapshot(NoSqlDatabase, test, testCommon)
  module.exports.tearDown(test, testCommon)
  var Iterator = NoSqlDatabase.prototype.IteratorClass
  if (Iterator.prototype._nextSync) {
